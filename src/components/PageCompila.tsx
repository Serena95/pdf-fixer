            ...
            {currentModello.obiettiviGarantiti && currentModello.obiettiviGarantiti.length > 0 && (
              <div className="rounded-md bg-white/80 border border-gray-300 p-3">
                ...
                <p className="mt-3 text-[12px] font-bold text-gray-800">
                  Garanzia di risultato minimo: si considera raggiunto al verificarsi di UNA SOLA delle voci della tabella obiettivi (non di tutte). Questa somma si intende a copertura di un massimo di 3 bandi l'anno.
                </p>
              </div>
            )}
          </div>
